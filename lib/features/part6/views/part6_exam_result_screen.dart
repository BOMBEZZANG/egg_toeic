...
class Part6ExamResultScreen extends ConsumerStatefulWidget {
  ...
  @override
  ConsumerState<Part6ExamResultScreen> createState() => _Part6ExamResultScreenState();
}

class _Part6ExamResultScreenState extends ConsumerState<Part6ExamResultScreen>
  ...
  Part6ExamResults _calculateResults() {
  ...
  Widget _buildOverviewTab(Part6ExamResults results) {
  ...
  Widget _buildScoreHeader(Part6ExamResults results) {
    return Container(
  ...
  Widget _buildPassagePerformance(Part6ExamResults results) {
  ...
  Widget _buildTimeStats(Part6ExamResults results) {
  ...
  Widget _buildQuestionsTab(Part6ExamResults results) {
...
// Data classes for Part6 exam results
class Part6ExamResults {
